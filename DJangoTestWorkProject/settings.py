"""
Django settings for DJangoTestWorkProject project.
...
SECRET_KEY = 'django-insecure-w*pzphn^+j2^1$+3dfntbgn*@s03tctlrww@*&mpy7&n2fk@+_'
...
WSGI_APPLICATION = 'DJangoTestWorkProject.wsgi.application'
