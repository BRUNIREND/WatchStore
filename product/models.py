...
class Products(models.Model):
    ...
    slug = models.SlugField(max_length=200, unique=True, blank=True, null=True, verbose_name='URL')
    discount = models.DecimalField(verbose_name='Скидка', default=0.00, max_digits=7, decimal_places=2)
    quantity = models.PositiveIntegerField(verbose_name='Количество', default=0)
    url_path = models.URLField(verbose_name='Ссылка на товар', default='')
    url_img = models.URLField(verbose_name='Ссылка на изображение', default='')
